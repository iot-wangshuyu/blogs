            ...
            <div class="row">
                <div class="col-md-9">
                    ...
                    <div style="margin-bottom: 10px;">
                        <input type="text" class="form-control input-lg" id="post_title" name="post_title"
                               placeholder="请输入文章标题" onblur="autoComplateUrl();"
                               value="<#if post??>${post.postTitle}</#if>">
                    </div>
                    <div style="display: block;margin-bottom: 10px;">
                        <span>
                            永久链接：
                            <a href="#">${options.blog_url}/archives/<span
                                    id="postUrl"><#if post??>${post.postUrl}</#if></span>/</a>
                ...
                <div class="col-md-3">
                                            ...
                                            <li style="padding: 0;margin: 0px;list-style: none">
                                                <label>
                                                    <input name="categories" id="categories" type="checkbox"
                                                           class="minimal"
                                                           value="${cate.cateId}" <#list post.categories as categorie> <#if  categorie.cateId =cate.cateId>
                                                           checked </#if>  </#list>>
                                                ${cate.cateName}
                                                </label>
                                            <#else>
                                                <label>
                                                    <input name="categories" id="categories" type="checkbox"
                                                           class="minimal" value="${cate.cateId}">
                                                ${cate.cateName}
                                                </label>
                                            </li>
                                            </#if>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <div>
                                <#if post??>
                                    <img src="${post.postThumbnail?default("/static/images/thumbnail.png")}"
                                         class="img-responsive img-thumbnail" id="selectImg"
                                         onclick="openAttach('selectImg')" style="cursor: pointer;">
                                <#else >
                                    <img src="/static/images/thumbnail.png" class="img-responsive img-thumbnail"
                                         id="selectImg" onclick="openAttach('selectImg')" style="cursor: pointer;">
                                </#if>
                            </div>
                        </div>
                    </div>
